...
# Textual Analysis Lab Notebook Template

## Required Components
- Reflections/observations from Voyant Tools, DataBasic, and Distant Reader in-class work
- Reflections/observations from AntConc and Python in-class work
- Report from your own text analysis experiment
  * Any PDF or TXT files you worked with
  * Any Python scripts/Jupyter Notebooks used
...
- [University Archive Resources](#university-archive-resources)
...
- [Your Turn!](#your-turn)
  ...
  * [Where to Start: Articulating a Research Question](#where-to-start-articulating-a-research-question)
...
[Link to this section of the lab procedure](https://github.com/kwaldenphd/football-text-analysis#university-archive-digital-collections)
...
[Link to this section of the lab procedure](https://github.com/kwaldenphd/football-text-analysis#voyant-tools)

Preliminary reflection questions for Voyant:
...
Reflection questions to consider as you explore the different tools and panels in Voyant:
...
[Link to this section of the lab procedure](https://github.com/kwaldenphd/football-text-analysis#databasic)

Word Counter Reflection Questions
...
Same Diff Reflection Questions
...
[Link to this section of the lab procedure](#https://github.com/kwaldenphd/football-text-analysis#on-your-own-distant-reader)
...
- How would you move forward with Distant Reader as a tool for historical textual analysis?
  * To put that another way, what types of historical research questions could a researcher have about a text or collection of texts? How effectively might Distant Reader be able to address those questions?
...
[Link to this section of the lab procedure](https://github.com/kwaldenphd/football-text-analysis/#antconc)
...
[Link to this section of the lab procedure](https://github.com/kwaldenphd/football-text-analysis/#python)
...
[Link to this section of the lab procedure](https://github.com/kwaldenphd/football-text-analysis/#next-steps-aka-now-its-your-turn)

By this point in the lab we've covered a number of different tools for (computational) text analysis, including some that run in a web browser, some that run on your local computer, and some that involve working within a programming language.
...
## Where to Start: Articulating a Research Question
...
We'll have in-class work time to work on this lab, and folks should anticipate spending 5-7 hours (total) outside class time working on this lab.
...
- [Link to online access via Hesburgh Libraries](https://onesearch.library.nd.edu/permalink/f/7uudnk/TN_cdi_askewsholts_vlebooks_9780268108243) (ND users)
