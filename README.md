...
63- Download the Files compressed folder in this repository. Extract the contents to a folder on your Desktop.

## Downloading AntConc

64-To download AntConc on your own computer, navigate to [the project website](http://www.laurenceanthony.net/software/antconc/), select the appropriate version for your operating system, and follow the installation instructions.
